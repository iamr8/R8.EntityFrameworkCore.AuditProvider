...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyAuditableEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyAuditableEntityWithoutSoftDelete", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MyAuditableEntitiesWithoutSoftDelete");
                });

            modelBuilder.Entity("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyAuditableEntity", b =>
                {
                    b.HasOne("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyAuditableEntity", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyEntity", b =>
                {
                    b.HasOne("R8.EntityFrameworkCore.AuditProvider.Tests.PostgreSqlTests.Entities.MyAuditableEntity", "MyAuditableEntity")
                        .WithMany("MyEntities")
                        .HasForeignKey("MyAuditableEntityId");
